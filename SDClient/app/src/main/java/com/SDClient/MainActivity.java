...
public class MainActivity extends AppCompatActivity {
    ...
    private Emitter.Listener DoorMsg = new Emitter.Listener() {
        @Override
        public void call(final Object... args) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    ...
                    if(receivedData.equals("이미 등록된 사용자입니다") || receivedData.equals("기기가 등록되었습니다")){
